...
public class Entrant110VerifyAcceptedEvent {
    ...
    @Test
    public void verifyUserStatusAcceptedEvent() throws InterruptedException {
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    if (documentSnapshot.exists()) {
                        ...
                        if (usersMap != null && usersMap.containsKey(deviceID)) {
                            ...
                            assertEquals("Device ID value does not match", Long.valueOf(2), eventIDValue);
                        } else {
