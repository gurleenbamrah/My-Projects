...
public class Entrant112VerifyDeclinedUser {
    ...
    @Test
    public void verifyEventStatusDeclinedUser() throws InterruptedException {
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    ...
                    if (documentSnapshot.exists()) {
                        ...
                        if (eventsMap != null && eventsMap.containsKey("150")) {
                            ...
                            assertEquals("Event ID value does not match", Long.valueOf(3), eventIDValue);
                        } else {
